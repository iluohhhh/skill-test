...
public class SRS {
	...
	public static void main(String[] args) {                                 //main
		...
		p1 = new Professor("111","Jacquie Barker", "123-45-6789", 
				   "Adjunct Professor", "Information Technology");		

		p2 = new Professor("222","John Smith", "567-81-2345",
				   "Full Professor", "Chemistry");		

		p3 = new Professor("333","Snidely Whiplash", "987-65-4321",
		...
		s1 = new Student("111","Joe Blow", "111-11-1111", "Math", "M.S.");

		s2 = new Student("222","Fred Schnurd", "222-22-2222", 
				 "Information Technology", "Ph. D.");

		s3 = new Student("333","Mary Smith", "333-33-3333", "Physics", "B.S.");
